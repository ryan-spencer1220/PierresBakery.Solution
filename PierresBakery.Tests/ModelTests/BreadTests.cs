...
namespace Bakery.Tests
{
  ...
  public class BreadTests
  {
    ...
    [TestMethod]
    public void GetBreadTotal4_ReturnTotalPriceOfBreads_Int()
    {
      int sourdough = 3;
      int baguette = 1;
      int pumpernickle = 2;
    ...
    [TestMethod]
    public void GetBreadTotal5_ReturnTotalPriceOfBreads_Int()
    {
      int sourdough = 3;
      int baguette = 2;
      int pumpernickle = 2;
    ...
    [TestMethod]
    public void GetBreadTotal6_ReturnTotalPriceOfBreads_Int()
    {
      int sourdough = 3;
      int baguette = 3;
      int pumpernickle = 2;
    ...
    [TestMethod]
    public void GetBreadTotal7_ReturnTotalPriceOfBreads_Int()
    {
      int sourdough = 3;
      int baguette = 3;
      int pumpernickle = 2;
